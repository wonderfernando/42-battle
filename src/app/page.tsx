...
export default function Home() {
  return (
    <div className="relative bg-[#1C0A00] grid grid-rows-[80px_1fr] items-center  z-10 justify-items-center min-h-screen">
    <Header/>
      <div className="flex flex-col items-center justify-center h-full gap-4 text-center z-10">
